...
<body class="bg-custom">
        ...
        $sql = mysqli_query($conn,"INSERT INTO agenda (cliente, email, servico, horario, dia_semana, dia_mes, mes, ano, data)
            ...
            if ($sql) {
                ...
                <div class='container pt-5'>
                   ...
                   <p class='display-7 bg-purple border border-primary p-1 text-light' style='border-radius:10px;'>Agendamento Concluído.</p>
    ...
    <button type="button" class="btn btn-info"><a href="../pages/menu.php">Voltar</a></button>
