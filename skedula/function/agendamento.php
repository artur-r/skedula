  ...
  <div class="container pt-5">
    ...
    while ($diaMes <= $diaMesFim && $diaMes <= $ultimoDiaMes) {
      ...
      if ($diaAtualSemana == "Domingo") {
        ...
        echo "<button type='button' class='btn w-25 btn-outline-primary'><a href='horarios.php'>$diaAtualSemana  <hr>  DIA $diaMes</button>";
      }
      $diaMes++;
    ...
    while ($diaMes == $ultimoDiaMes + 1 && $quantidadeBotoes < $limiteBotoes) {
      ...
      if ($diaAtualSemana == "Domingo") {
        ...
        echo "<button type='button' class='btn w-25 btn-outline-primary'><a href='horarios.php'>$diaAtualSemana  <hr>  DIA $inicioProximoMes</button>";
      }
