...
<body class="bg-custom">
    ...
    <div class="container pt-5">
        <p class="display-7 bg-purple border border-primary p-1 text-light" style="border-radius:10px;">Clique em um agendamento para executar o cancelamento</p>
    </div>
    ...
    <table  class='table table-dark table-hover' >
        <tr>
        <th>Serviço agendado</th> <th>Dia agendado</th><th>Horário</th><th>data</th><th>Ação</th>
        </tr>        
...
<tr>
    ...
    while ($resultado = mysqli_fetch_assoc($consulta)) {
        ...
        //adicionar espaço entre as palaveas do serviço corteebarba
        if ($resultado['servico'] == "corteebarba"){
            $resultado['servico'] = "corte e barba";
        }
